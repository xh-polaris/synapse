...
func newSchool(db *gorm.DB, opts ...gen.DOOption) school {
	...
	_school.ID = field.NewField(tableName, "id")
	_school.Name = field.NewString(tableName, "name")
	_school.Extra = field.NewField(tableName, "extra")
	_school.CreatedAt = field.NewInt64(tableName, "created_at")
	_school.UpdatedAt = field.NewInt64(tableName, "updated_at")
