...
type BasicUser struct {
	...
	SchoolID  *id.ID         `gorm:"column:school_id;autoIncrement:false;type:binary(12);uniqueIndex:uidx_school_student" json:"school_id"` // SchoolID 学校ID
	StudentID *string        `gorm:"column:student_id;type:varchar(24);uniqueIndex:uidx_school_student" json:"student_id"`                  // StudentID 学号
